            ...
            <div class="row tm-row" style="justify-content: center; vertical-align: center; margin: auto;">
                <div class="col-lg-8 tm-post-col">
                    <div class="tm-post-full">
                        <form action="<?php echo base_url('C_login/login_action') ?>" method="post" class="mb-5 tm-comment-form">
                            ...
                            <div>
                                <table width="100%">
                                    <tr>
                                        <td align="right"><button type="submit" align="right" style="background-color: #0CC;" class="btn btn-success btn-lg">Login</button></td>
                                    </tr>
                                    <tr>
                                        <td align="left">Have an account? <a href="<?php echo base_url('C_login/signup_page') ?>">Sign Up</a></td>
                                    </tr>
                                </table>
                            </div>
                        </form>
